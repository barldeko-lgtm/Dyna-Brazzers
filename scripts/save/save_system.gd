...
func apply_save_button_text(button: Button, text_value: String, preferred_font_size: int, minimum_font_size: int) -> void:
	if system_menu != null and is_instance_valid(system_menu):
		system_menu.call("apply_save_button_text", button, text_value, preferred_font_size, minimum_font_size)
...
func return_to_main_menu_from_result() -> void:
	if system_menu != null and is_instance_valid(system_menu):
		system_menu.call("_on_main_menu_pressed")
