...
Defender raptors may also protect an allied herbivore from a predator of the opposing faction. The first raptor to reach the attacker reserves the intervention, waits for the next scheduled duel hit to finish, then replaces the herbivore in a new one-on-one duel. The protected herbivore leaves combat, and the replacement duel cannot be interrupted again. Predator-versus-predator duels are never eligible for this protection.
