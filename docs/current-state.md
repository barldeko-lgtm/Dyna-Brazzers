...
- есть debug UI для просмотра статов существа;
...
### Существа
- В мире уже размещены несколько тестовых существ.
...
- При достижении `10` лет существо умирает и удаляется из мира.
...
- Есть hover UI со статами существа.
- В hover UI сейчас показываются имя, возраст, здоровье и сытость.
- Есть FPS-метка.
...
- Визуал существа сейчас debug / placeholder-уровня.
...
- Нет яиц, размножения существ и роста популяции.
- Нет боевой системы.
