...
- `scripts/creatures/behaviors/creature_grazing_logic.gd` — herbivore search over ten eligible 2x2 pasture candidates, current reachable-route comparison, final `food value - path steps * 2` ranking, and movement-controller-owned grazing routes.
