...
### Папка `assets/`
Пока хранит базовые спрайты и плейсхолдеры.
...
- `assets/sprites/creatures/debug_square_256.png` — текущий debug-спрайт существа.
- `assets/sprites/creatures/stegosaurus_placeholder.png` — плейсхолдер стегозавра.
...
**Что важно помнить:**
- сейчас используется debug-представление;
...
**Отвечает за:**
- состояния `IDLE`, `WALK`, `SEEK_FOOD`, `EATING`;
- голод и потерю здоровья при голоде;
- выбор пастбища;
...
**Отвечает за:**
- показ панели по наведению на существо;
- отображение возраста, здоровья и сытости;
...
- UI запрашивает у существа имя, здоровье и сытость.
